...
const char *recognize_sinlge_symbol_and_count_it(const char *infix_notation_row, int length_without_terminator, char symbol_to_recognize, int *lexeme_counter_out);
...
const char *recognize_function_and_count_it(const char *infix_notation_row, int length_without_terminator, const char *function_name_as_string, int function_name_length_without_terminator, int *lexeme_counter_out);
